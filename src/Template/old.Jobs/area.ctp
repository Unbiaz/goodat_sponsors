...
<div class="uk-float-right uk-margin-bottom">
  <div class="uk-button-group">
    <div class="uk-inline">
          <button class="uk-button uk-button-primary bg-green uk-button-small uk-margin-small-top" type="button"><?= h($area->name) ?> <i class="uk-margin-small-left" uk-icon="icon:  triangle-down"></i></button>
