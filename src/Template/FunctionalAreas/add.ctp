...
/**
  ...
  */
?>
<h4 class="uk-margin-small-bottom uk-text-center txt-green">Add new Functional Area</h4>
...
<div class="uk-panel uk-padding-small bg-green uk-width-1-3@s uk-width-2-5@m uk-container-center">
    ...
    <?= $this->Form->create($functionalArea, ['class' => 'uuk-grid-small uk-child-width-1-1', 'uk-grid'=>'']) ?>
        ...
        <?= $this->Form->control('name', ['class' => 'uk-input uk-form-small', 'placeholder' => 'Enter a functional area', 'label' => 'Name of functional area']);?>
